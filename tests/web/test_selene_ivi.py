from pages.web.main_page import open_page, close_cookie, NotAuthorised, Authorised, return_to_main_page
import allure
from tests.web.conftest import email, password
...
def test_authorisation():
    ...
    with allure.step("Авторизуемся как существующий пользователь через логин и пароль"):
        main_page.authorization(email, password)
